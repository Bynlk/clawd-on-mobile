...
(function initSettingsI18n(root) {
  const WG_RELAY_STRINGS = {
    en: {
      sidebarWgRelay: "Remote Connection",
      wgRelayTitle: "Remote Connection",
      wgRelaySubtitle: "Deploy your own WireGuard Relay, then connect this PC and pair one phone.",
      wgRelaySetupTitle: "Deploy a remote connection",
      wgRelaySetupDescription: "Enter the four SSH details below. Clawd installs and configures the Relay for you.",
      wgRelayFieldHost: "Public IP or domain",
      wgRelayFieldSshUsername: "SSH username",
      wgRelayFieldSshPort: "SSH port",
      wgRelayFieldPassword: "SSH password",
      wgRelayFieldWgPort: "WireGuard UDP port",
      wgRelayFieldSubnet: "WireGuard subnet",
      wgRelayFieldRelayPort: "Relay port",
      wgRelayPasswordOneTimeHint: "Used only for this deployment. The password is cleared immediately after submission and is not saved.",
      wgRelayRepairPasswordHint: "Enter the current SSH password. A password from an earlier deployment is never retained or reused.",
      wgRelayDeploy: "Deploy remote connection",
      wgRelayDeploying: "Deploying…",
      wgRelayTryDeployAgain: "Try deployment again",
      wgRelayDeploymentFailedTitle: "Deployment failed",
      wgRelayShowDetails: "Show details",
      wgRelayProgressOverall: "Overall progress",
      wgRelayProgressLabel: "Deployment progress",
      wgRelayStep_connect: "Connect to VPS",
      wgRelayStep_fingerprint: "Confirm SSH fingerprint",
      wgRelayStep_upload: "Upload Relay files",
      wgRelayStep_dependencies: "Install system dependencies",
      wgRelayStep_wireguard: "Configure WireGuard",
      wgRelayStep_relay: "Configure Relay and firewall",
      wgRelayStep_verify: "Start and verify services",
      wgRelayStep_save: "Save PC configuration",
      wgRelayStep_pcConnect: "Connect this PC",
      wgRelayStep_qr: "Generate phone pairing QR code",
      wgRelayProgress_pending: "Pending",
      wgRelayProgress_current: "In progress",
      wgRelayProgress_completed: "Completed",
      wgRelayProgress_failed: "Failed",
      wgRelayStatus_checking: "Checking connection…",
      wgRelayStatus_idle: "Not connected",
      wgRelayStatus_starting_tunnel: "Starting tunnel",
      wgRelayStatus_verifying_relay: "Verifying Relay",
      wgRelayStatus_connecting_relay: "Connecting Relay",
      wgRelayStatus_connected: "Connected",
      wgRelayStatus_disconnecting: "Disconnecting",
      wgRelayStatus_failed: "Connection failed",
      wgRelayChecking: "Checking…",
      wgRelayConnect: "Connect this computer",
      wgRelayConnecting: "Connecting…",
      wgRelayDisconnect: "Disconnect remote connection",
      wgRelayDisconnecting: "Disconnecting…",
      wgRelayVpsRow: "VPS Relay",
      wgRelayComputerRow: "This computer",
      wgRelayAndroidRow: "Android",
      wgRelayVpsConfigured: "Configured",
      wgRelayAndroidChecking: "Checking pairing availability…",
      wgRelayAndroidPairingAvailable: "Pairing available",
      wgRelayAndroidUnavailable: "Unavailable until repair",
      wgRelayAdvancedManagement: "Advanced management",
      wgRelayRepairRequiredTitle: "Repair required",
      wgRelayShowQr: "Show pairing QR code",
      wgRelayRotatePhone: "Pair a different phone",
      wgRelayRepair: "Repair / redeploy",
      wgRelayDelete: "Delete configuration",
      wgRelayRecoveryRequired: "Repair or redeploy is required before this connection can be used.",
      wgRelayQrTitle: "Phone pairing QR code",
      wgRelayQrAlt: "QR code for pairing the Clawd mobile app with this Relay",
      wgRelayQrWarning: "This QR code contains sensitive pairing data. Show it only to the phone you want to pair and close it when finished.",
      wgRelayQrClose: "Close QR code",
      wgRelayRotateConfirmTitle: "Pair a different phone?",
      wgRelayRotateConfirmDetail: "The old phone will become invalid immediately and will no longer be able to connect.",
      wgRelayRotateConfirmAction: "Invalidate old phone",
      wgRelayDeleteConfirmTitle: "Delete local configuration?",
      wgRelayDeleteConfirmDetail: "This removes the configuration and secrets from this PC. Services on the VPS will keep running.",
      wgRelayDeleteConfirmAction: "Delete local configuration",
      wgRelayRepairTitle: "Repair or redeploy",
      wgRelayRepairDescription: "Review the advanced defaults and enter the current SSH password to run the idempotent deployment again.",
      wgRelayRepairDeploy: "Repair / redeploy",
      wgRelayCancel: "Cancel",
      wgRelayError_invalid_profile: "Check the public address, SSH username, and SSH port.",
      wgRelayError_password_required: "Enter the SSH password for this deployment.",
      wgRelayError_runtime_unavailable: "Remote Connection is unavailable in this build.",
      wgRelayError_deploy_failed: "Deployment failed. Check the VPS address, SSH access, and firewall, then try repair / redeploy.",
      wgRelayError_deploy_aborted: "Deployment was cancelled. Run repair / redeploy before trying again.",
      wgRelayError_remote_commit_recovery_required: "The VPS may have changed, but the local save did not finish. Repair or redeploy before connecting.",
      wgRelayError_profile_conflict_recovery_required: "The profile changed during deployment. Review it, then repair or redeploy.",
      wgRelayError_secure_storage_unavailable: "Secure local storage is unavailable. Clawd will not save Relay secrets without encryption.",
      wgRelayError_secret_store_read_failed: "The encrypted Relay data could not be read. Repair or redeploy is required.",
      wgRelayError_local_storage_retry_required: "The VPS is ready, but encrypted local storage still needs repair.",
      wgRelayError_public_profile_retry_required: "The VPS is ready, but the public profile still needs to be saved.",
      wgRelayError_connection_retry_required: "Deployment finished, but this PC could not connect. Try Remote connect again.",
      wgRelayError_pairing_qr_retry_required: "Deployment finished, but the pairing QR code could not be generated. Try showing it again.",
      wgRelayError_invalid_profile_id: "The selected Relay profile is invalid.",
      wgRelayError_profile_not_found: "The Relay profile no longer exists on this PC.",
      wgRelayError_secrets_not_found: "Encrypted Relay secrets are missing. Repair or redeploy is required.",
      wgRelayError_pairing_qr_failed: "The pairing QR code could not be generated.",
      wgRelayError_rotate_failed: "The phone could not be re-paired. The previous pairing may still be active.",
      wgRelayError_rotate_aborted: "Phone re-pairing was cancelled. Check the connection before trying again.",
      wgRelayError_delete_prepare_failed: "Clawd could not safely prepare the local deletion. Nothing was deleted.",
      wgRelayError_delete_failed: "The local configuration could not be fully deleted. Try again.",
      wgRelayError_connection_failed: "This PC could not establish the remote connection.",
      wgRelayError_sidecar_failed: "The built-in WireGuard tunnel could not start on this platform.",
      wgRelayError_health_failed: "The WireGuard tunnel started, but the Relay health check failed.",
      wgRelayError_relay_failed: "The Relay connection could not be established.",
      wgRelayError_unknown: "Remote Connection failed. Try again or use Repair / redeploy.",
    },
    zh: {
      sidebarWgRelay: "远程连接",
      wgRelayTitle: "远程连接",
      wgRelaySubtitle: "一键部署你自己的 WireGuard Relay，然后连接这台电脑并配对一台手机。",
      wgRelaySetupTitle: "部署远程连接",
      wgRelaySetupDescription: "填写下面 4 项 SSH 信息，Clawd 会自动安装并配置 Relay。",
      wgRelayFieldHost: "公网 IP 或域名",
      wgRelayFieldSshUsername: "SSH 用户名",
      wgRelayFieldSshPort: "SSH 端口",
      wgRelayFieldPassword: "SSH 密码",
      wgRelayFieldWgPort: "WireGuard UDP 端口",
      wgRelayFieldSubnet: "WireGuard 内网段",
      wgRelayFieldRelayPort: "Relay 端口",
      wgRelayPasswordOneTimeHint: "仅用于本次部署。提交后密码会立即清空，不会保存。",
      wgRelayRepairPasswordHint: "请输入当前 SSH 密码；之前部署使用的密码从不保留，也不会复用。",
      wgRelayDeploy: "部署远程连接",
      wgRelayDeploying: "正在部署…",
      wgRelayTryDeployAgain: "重新尝试部署",
      wgRelayDeploymentFailedTitle: "部署失败",
      wgRelayShowDetails: "显示详情",
      wgRelayProgressOverall: "总体进度",
      wgRelayProgressLabel: "部署进度",
      wgRelayStep_connect: "连接 VPS",
      wgRelayStep_fingerprint: "确认 SSH 指纹",
      wgRelayStep_upload: "上传 Relay 文件",
      wgRelayStep_dependencies: "安装系统依赖",
      wgRelayStep_wireguard: "配置 WireGuard",
      wgRelayStep_relay: "配置 Relay 与防火墙",
      wgRelayStep_verify: "启动并验证服务",
      wgRelayStep_save: "保存 PC 配置",
      wgRelayStep_pcConnect: "连接这台电脑",
      wgRelayStep_qr: "生成手机配对二维码",
      wgRelayProgress_pending: "等待中",
      wgRelayProgress_current: "进行中",
      wgRelayProgress_completed: "已完成",
      wgRelayProgress_failed: "失败",
      wgRelayStatus_checking: "正在检查连接",
      wgRelayStatus_idle: "未连接",
      wgRelayStatus_starting_tunnel: "正在启动隧道",
      wgRelayStatus_verifying_relay: "正在验证 Relay",
      wgRelayStatus_connecting_relay: "正在连接 Relay",
      wgRelayStatus_connected: "已连接",
      wgRelayStatus_disconnecting: "正在断开",
      wgRelayStatus_failed: "连接失败",
      wgRelayChecking: "正在检查…",
      wgRelayConnect: "连接这台电脑",
      wgRelayConnecting: "正在连接…",
      wgRelayDisconnect: "断开远程连接",
      wgRelayDisconnecting: "正在断开…",
      wgRelayVpsRow: "VPS Relay",
      wgRelayComputerRow: "这台电脑",
      wgRelayAndroidRow: "Android",
      wgRelayVpsConfigured: "已配置",
      wgRelayAndroidChecking: "正在检查配对状态",
      wgRelayAndroidPairingAvailable: "可配对",
      wgRelayAndroidUnavailable: "修复前不可用",
      wgRelayAdvancedManagement: "高级管理",
      wgRelayRepairRequiredTitle: "需要修复",
      wgRelayShowQr: "显示配对二维码",
      wgRelayRotatePhone: "重新配对手机",
      wgRelayRepair: "修复 / 重新部署",
      wgRelayDelete: "删除配置",
      wgRelayRecoveryRequired: "需要修复或重新部署，完成前不能使用此连接。",
      wgRelayQrTitle: "手机配对二维码",
      wgRelayQrAlt: "用于将 Clawd 手机端与此 Relay 配对的二维码",
      wgRelayQrWarning: "二维码包含敏感配对数据。只向要配对的手机展示，完成后请立即关闭。",
      wgRelayQrClose: "关闭二维码",
      wgRelayRotateConfirmTitle: "重新配对手机？",
      wgRelayRotateConfirmDetail: "旧手机会立即失效，之后将无法再连接。",
      wgRelayRotateConfirmAction: "让旧手机失效",
      wgRelayDeleteConfirmTitle: "删除本地配置？",
      wgRelayDeleteConfirmDetail: "这会删除本机配置和秘密数据；VPS 上的服务会继续运行。",
      wgRelayDeleteConfirmAction: "删除本地配置",
      wgRelayRepairTitle: "修复或重新部署",
      wgRelayRepairDescription: "检查高级默认值，并输入当前 SSH 密码，再次运行幂等部署。",
      wgRelayRepairDeploy: "修复 / 重新部署",
      wgRelayCancel: "取消",
      wgRelayError_invalid_profile: "请检查公网地址、SSH 用户名和 SSH 端口。",
      wgRelayError_password_required: "请输入本次部署使用的 SSH 密码。",
      wgRelayError_runtime_unavailable: "当前版本无法使用远程连接。",
      wgRelayError_deploy_failed: "部署失败。请检查 VPS 地址、SSH 登录和防火墙，然后重试修复 / 重新部署。",
      wgRelayError_deploy_aborted: "部署已取消。再次使用前请运行修复 / 重新部署。",
      wgRelayError_remote_commit_recovery_required: "VPS 可能已经变更，但本地保存未完成。连接前必须修复或重新部署。",
      wgRelayError_profile_conflict_recovery_required: "部署期间配置发生变化。请检查后修复或重新部署。",
      wgRelayError_secure_storage_unavailable: "安全存储不可用；Clawd 不会以明文保存 Relay 秘密。",
      wgRelayError_secret_store_read_failed: "无法读取加密的 Relay 数据，需要修复或重新部署。",
      wgRelayError_local_storage_retry_required: "VPS 已就绪，但本机加密存储仍需修复。",
      wgRelayError_public_profile_retry_required: "VPS 已就绪，但公开配置仍未保存。",
      wgRelayError_connection_retry_required: "部署已完成，但本机连接失败。请再次点击远程连接。",
      wgRelayError_pairing_qr_retry_required: "部署已完成，但二维码生成失败。请再次尝试显示二维码。",
      wgRelayError_invalid_profile_id: "所选 Relay 配置无效。",
      wgRelayError_profile_not_found: "本机已不存在该 Relay 配置。",
      wgRelayError_secrets_not_found: "加密的 Relay 秘密缺失，需要修复或重新部署。",
      wgRelayError_pairing_qr_failed: "无法生成配对二维码。",
      wgRelayError_rotate_failed: "手机重新配对失败；原配对可能仍然有效。",
      wgRelayError_rotate_aborted: "手机重新配对已取消，请检查连接后重试。",
      wgRelayError_delete_prepare_failed: "无法安全准备本地删除，尚未删除任何内容。",
      wgRelayError_delete_failed: "未能完整删除本地配置，请重试。",
      wgRelayError_connection_failed: "这台电脑无法建立远程连接。",
      wgRelayError_sidecar_failed: "内置 WireGuard 隧道无法在当前平台启动。",
      wgRelayError_health_failed: "WireGuard 隧道已启动，但 Relay 健康检查失败。",
      wgRelayError_relay_failed: "无法建立 Relay 连接。",
      wgRelayError_unknown: "远程连接失败，请重试或使用修复 / 重新部署。",
    },
    "zh-TW": {
      sidebarWgRelay: "遠端連線",
      wgRelayTitle: "遠端連線",
      wgRelaySubtitle: "一鍵部署你自己的 WireGuard Relay，然後連接這台電腦並配對一支手機。",
      wgRelaySetupTitle: "部署遠端連線",
      wgRelaySetupDescription: "填寫下列 4 項 SSH 資訊，Clawd 會自動安裝並設定 Relay。",
      wgRelayFieldHost: "公網 IP 或網域",
      wgRelayFieldSshUsername: "SSH 使用者名稱",
      wgRelayFieldSshPort: "SSH 連接埠",
      wgRelayFieldPassword: "SSH 密碼",
      wgRelayFieldWgPort: "WireGuard UDP 連接埠",
      wgRelayFieldSubnet: "WireGuard 子網路",
      wgRelayFieldRelayPort: "Relay 連接埠",
      wgRelayPasswordOneTimeHint: "僅用於本次部署。送出後密碼會立即清除，不會儲存。",
      wgRelayRepairPasswordHint: "請輸入目前的 SSH 密碼；之前部署使用的密碼不會保留或重用。",
      wgRelayDeploy: "部署遠端連線",
      wgRelayDeploying: "正在部署…",
      wgRelayTryDeployAgain: "重新嘗試部署",
      wgRelayDeploymentFailedTitle: "部署失敗",
      wgRelayShowDetails: "顯示詳細資訊",
      wgRelayProgressOverall: "整體進度",
      wgRelayProgressLabel: "部署進度",
      wgRelayStep_connect: "連線 VPS",
      wgRelayStep_fingerprint: "確認 SSH 指紋",
      wgRelayStep_upload: "上傳 Relay 檔案",
      wgRelayStep_dependencies: "安裝系統相依套件",
      wgRelayStep_wireguard: "設定 WireGuard",
      wgRelayStep_relay: "設定 Relay 與防火牆",
      wgRelayStep_verify: "啟動並驗證服務",
      wgRelayStep_save: "儲存 PC 設定",
      wgRelayStep_pcConnect: "連接這台電腦",
      wgRelayStep_qr: "產生手機配對 QR Code",
      wgRelayProgress_pending: "等待中",
      wgRelayProgress_current: "進行中",
      wgRelayProgress_completed: "已完成",
      wgRelayProgress_failed: "失敗",
      wgRelayStatus_checking: "正在檢查連線",
      wgRelayStatus_idle: "未連線",
      wgRelayStatus_starting_tunnel: "正在啟動隧道",
      wgRelayStatus_verifying_relay: "正在驗證 Relay",
      wgRelayStatus_connecting_relay: "正在連接 Relay",
      wgRelayStatus_connected: "已連線",
      wgRelayStatus_disconnecting: "正在中斷連線",
      wgRelayStatus_failed: "連線失敗",
      wgRelayChecking: "正在檢查…",
      wgRelayConnect: "連接這台電腦",
      wgRelayConnecting: "正在連線…",
      wgRelayDisconnect: "中斷遠端連線",
      wgRelayDisconnecting: "正在中斷連線…",
      wgRelayVpsRow: "VPS Relay",
      wgRelayComputerRow: "這台電腦",
      wgRelayAndroidRow: "Android",
      wgRelayVpsConfigured: "已設定",
      wgRelayAndroidChecking: "正在檢查配對狀態",
      wgRelayAndroidPairingAvailable: "可配對",
      wgRelayAndroidUnavailable: "修復前無法使用",
      wgRelayAdvancedManagement: "進階管理",
      wgRelayRepairRequiredTitle: "需要修復",
      wgRelayShowQr: "顯示配對 QR Code",
      wgRelayRotatePhone: "重新配對手機",
      wgRelayRepair: "修復 / 重新部署",
      wgRelayDelete: "刪除設定",
      wgRelayRecoveryRequired: "需要修復或重新部署，完成前不能使用此連線。",
      wgRelayQrTitle: "手機配對 QR Code",
      wgRelayQrAlt: "用於將 Clawd 手機端與此 Relay 配對的 QR Code",
      wgRelayQrWarning: "QR Code 包含敏感配對資料。只向要配對的手機顯示，完成後請關閉。",
      wgRelayQrClose: "關閉 QR Code",
      wgRelayRotateConfirmTitle: "重新配對手機？",
      wgRelayRotateConfirmDetail: "舊手機會立即失效，之後將無法再連線。",
      wgRelayRotateConfirmAction: "讓舊手機失效",
      wgRelayDeleteConfirmTitle: "刪除本機設定？",
      wgRelayDeleteConfirmDetail: "這會刪除本機設定與秘密資料；VPS 上的服務會繼續執行。",
      wgRelayDeleteConfirmAction: "刪除本機設定",
      wgRelayRepairTitle: "修復或重新部署",
      wgRelayRepairDescription: "檢查進階預設值，並輸入目前的 SSH 密碼，再次執行冪等部署。",
      wgRelayRepairDeploy: "修復 / 重新部署",
      wgRelayCancel: "取消",
      wgRelayError_invalid_profile: "請檢查公網位址、SSH 使用者名稱與 SSH 連接埠。",
      wgRelayError_password_required: "請輸入本次部署使用的 SSH 密碼。",
      wgRelayError_runtime_unavailable: "目前版本無法使用遠端連線。",
      wgRelayError_deploy_failed: "部署失敗。請檢查 VPS 位址、SSH 登入與防火牆後重試。",
      wgRelayError_deploy_aborted: "部署已取消，再次使用前請修復或重新部署。",
      wgRelayError_remote_commit_recovery_required: "VPS 可能已變更，但本機儲存未完成。連線前必須修復或重新部署。",
      wgRelayError_profile_conflict_recovery_required: "部署期間設定發生變更，請檢查後修復或重新部署。",
      wgRelayError_secure_storage_unavailable: "安全儲存不可用；Clawd 不會以明文儲存 Relay 秘密。",
      wgRelayError_secret_store_read_failed: "無法讀取加密的 Relay 資料，需要修復或重新部署。",
      wgRelayError_local_storage_retry_required: "VPS 已就緒，但本機加密儲存仍需修復。",
      wgRelayError_public_profile_retry_required: "VPS 已就緒，但公開設定仍未儲存。",
      wgRelayError_connection_retry_required: "部署已完成，但本機連線失敗。請再次點選遠端連線。",
      wgRelayError_pairing_qr_retry_required: "部署已完成，但 QR Code 產生失敗，請重試。",
      wgRelayError_invalid_profile_id: "所選 Relay 設定無效。",
      wgRelayError_profile_not_found: "本機已不存在該 Relay 設定。",
      wgRelayError_secrets_not_found: "加密的 Relay 秘密遺失，需要修復或重新部署。",
      wgRelayError_pairing_qr_failed: "無法產生配對 QR Code。",
      wgRelayError_rotate_failed: "手機重新配對失敗；原配對可能仍然有效。",
      wgRelayError_rotate_aborted: "手機重新配對已取消，請檢查連線後重試。",
      wgRelayError_delete_prepare_failed: "無法安全準備本機刪除，尚未刪除任何內容。",
      wgRelayError_delete_failed: "未能完整刪除本機設定，請重試。",
      wgRelayError_connection_failed: "這台電腦無法建立遠端連線。",
      wgRelayError_sidecar_failed: "內建 WireGuard 隧道無法在目前平台啟動。",
      wgRelayError_health_failed: "WireGuard 隧道已啟動，但 Relay 健康檢查失敗。",
      wgRelayError_relay_failed: "無法建立 Relay 連線。",
      wgRelayError_unknown: "遠端連線失敗，請重試或使用修復 / 重新部署。",
    },
    ko: {
      sidebarWgRelay: "원격 연결",
      wgRelayTitle: "원격 연결",
      wgRelaySubtitle: "자체 WireGuard Relay를 한 번에 배포한 뒤 이 PC를 연결하고 휴대폰 한 대를 페어링합니다.",
      wgRelaySetupTitle: "원격 연결 배포",
      wgRelaySetupDescription: "아래 SSH 정보 4개를 입력하면 Clawd가 Relay를 자동으로 설치하고 구성합니다.",
      wgRelayFieldHost: "공인 IP 또는 도메인",
      wgRelayFieldSshUsername: "SSH 사용자 이름",
      wgRelayFieldSshPort: "SSH 포트",
      wgRelayFieldPassword: "SSH 비밀번호",
      wgRelayFieldWgPort: "WireGuard UDP 포트",
      wgRelayFieldSubnet: "WireGuard 서브넷",
      wgRelayFieldRelayPort: "Relay 포트",
      wgRelayPasswordOneTimeHint: "이번 배포에만 사용됩니다. 제출 즉시 비밀번호가 지워지며 저장되지 않습니다.",
      wgRelayRepairPasswordHint: "현재 SSH 비밀번호를 입력하세요. 이전 배포 비밀번호는 보관하거나 재사용하지 않습니다.",
      wgRelayDeploy: "원격 연결 배포",
      wgRelayDeploying: "배포 중…",
      wgRelayTryDeployAgain: "배포 다시 시도",
      wgRelayDeploymentFailedTitle: "배포 실패",
      wgRelayShowDetails: "세부 정보 보기",
      wgRelayProgressOverall: "전체 진행률",
      wgRelayProgressLabel: "배포 진행 상황",
      wgRelayStep_connect: "VPS 연결",
      wgRelayStep_fingerprint: "SSH 지문 확인",
      wgRelayStep_upload: "Relay 파일 업로드",
      wgRelayStep_dependencies: "시스템 종속성 설치",
      wgRelayStep_wireguard: "WireGuard 구성",
      wgRelayStep_relay: "Relay 및 방화벽 구성",
      wgRelayStep_verify: "서비스 시작 및 검증",
      wgRelayStep_save: "PC 구성 저장",
      wgRelayStep_pcConnect: "이 PC 연결",
      wgRelayStep_qr: "휴대폰 페어링 QR 코드 생성",
      wgRelayProgress_pending: "대기",
      wgRelayProgress_current: "진행 중",
      wgRelayProgress_completed: "완료",
      wgRelayProgress_failed: "실패",
      wgRelayStatus_checking: "연결 확인 중",
      wgRelayStatus_idle: "연결 안 됨",
      wgRelayStatus_starting_tunnel: "터널 시작 중",
      wgRelayStatus_verifying_relay: "Relay 확인 중",
      wgRelayStatus_connecting_relay: "Relay 연결 중",
      wgRelayStatus_connected: "연결됨",
      wgRelayStatus_disconnecting: "연결 해제 중",
      wgRelayStatus_failed: "연결 실패",
      wgRelayChecking: "확인 중…",
      wgRelayConnect: "이 컴퓨터 연결",
      wgRelayConnecting: "연결 중…",
      wgRelayDisconnect: "원격 연결 해제",
      wgRelayDisconnecting: "연결 해제 중…",
      wgRelayVpsRow: "VPS Relay",
      wgRelayComputerRow: "이 컴퓨터",
      wgRelayAndroidRow: "Android",
      wgRelayVpsConfigured: "구성됨",
      wgRelayAndroidChecking: "페어링 가능 여부 확인 중",
      wgRelayAndroidPairingAvailable: "페어링 가능",
      wgRelayAndroidUnavailable: "복구 전까지 사용할 수 없음",
      wgRelayAdvancedManagement: "고급 관리",
      wgRelayRepairRequiredTitle: "복구 필요",
      wgRelayShowQr: "페어링 QR 코드 표시",
      wgRelayRotatePhone: "다른 휴대폰 페어링",
      wgRelayRepair: "복구 / 재배포",
      wgRelayDelete: "구성 삭제",
      wgRelayRecoveryRequired: "이 연결을 사용하려면 먼저 복구하거나 재배포해야 합니다.",
      wgRelayQrTitle: "휴대폰 페어링 QR 코드",
      wgRelayQrAlt: "Clawd 모바일 앱을 이 Relay와 페어링하는 QR 코드",
      wgRelayQrWarning: "이 QR 코드에는 민감한 페어링 데이터가 포함됩니다. 페어링할 휴대폰에만 보여 주고 완료 후 닫으세요.",
      wgRelayQrClose: "QR 코드 닫기",
      wgRelayRotateConfirmTitle: "다른 휴대폰을 페어링할까요?",
      wgRelayRotateConfirmDetail: "기존 휴대폰은 즉시 무효화되어 더 이상 연결할 수 없습니다.",
      wgRelayRotateConfirmAction: "기존 휴대폰 무효화",
      wgRelayDeleteConfirmTitle: "로컬 구성을 삭제할까요?",
      wgRelayDeleteConfirmDetail: "이 PC의 구성과 비밀 데이터가 삭제됩니다. VPS 서비스는 계속 실행됩니다.",
      wgRelayDeleteConfirmAction: "로컬 구성 삭제",
      wgRelayRepairTitle: "복구 또는 재배포",
      wgRelayRepairDescription: "고급 기본값을 확인하고 현재 SSH 비밀번호를 입력하여 배포를 다시 실행합니다.",
      wgRelayRepairDeploy: "복구 / 재배포",
      wgRelayCancel: "취소",
      wgRelayError_invalid_profile: "공인 주소, SSH 사용자 이름 및 포트를 확인하세요.",
      wgRelayError_password_required: "이번 배포에 사용할 SSH 비밀번호를 입력하세요.",
      wgRelayError_runtime_unavailable: "이 빌드에서는 원격 연결을 사용할 수 없습니다.",
      wgRelayError_deploy_failed: "배포에 실패했습니다. VPS 주소, SSH 접속 및 방화벽을 확인한 뒤 다시 시도하세요.",
      wgRelayError_deploy_aborted: "배포가 취소되었습니다. 다시 사용하기 전에 복구하거나 재배포하세요.",
      wgRelayError_remote_commit_recovery_required: "VPS가 변경되었을 수 있지만 로컬 저장이 끝나지 않았습니다. 연결 전에 복구하거나 재배포하세요.",
      wgRelayError_profile_conflict_recovery_required: "배포 중 구성이 변경되었습니다. 확인 후 복구하거나 재배포하세요.",
      wgRelayError_secure_storage_unavailable: "보안 저장소를 사용할 수 없어 Relay 비밀을 저장하지 않습니다.",
      wgRelayError_secret_store_read_failed: "암호화된 Relay 데이터를 읽을 수 없습니다. 복구 또는 재배포가 필요합니다.",
      wgRelayError_local_storage_retry_required: "VPS는 준비되었지만 로컬 암호화 저장소를 복구해야 합니다.",
      wgRelayError_public_profile_retry_required: "VPS는 준비되었지만 공개 프로필 저장이 필요합니다.",
      wgRelayError_connection_retry_required: "배포는 끝났지만 이 PC가 연결되지 않았습니다. 원격 연결을 다시 시도하세요.",
      wgRelayError_pairing_qr_retry_required: "배포는 끝났지만 QR 코드를 만들지 못했습니다. 다시 표시해 보세요.",
      wgRelayError_invalid_profile_id: "선택한 Relay 프로필이 올바르지 않습니다.",
      wgRelayError_profile_not_found: "이 PC에 Relay 프로필이 없습니다.",
      wgRelayError_secrets_not_found: "암호화된 Relay 비밀이 없습니다. 복구 또는 재배포가 필요합니다.",
      wgRelayError_pairing_qr_failed: "페어링 QR 코드를 만들 수 없습니다.",
      wgRelayError_rotate_failed: "휴대폰 재페어링에 실패했습니다. 기존 페어링은 아직 유효할 수 있습니다.",
      wgRelayError_rotate_aborted: "휴대폰 재페어링이 취소되었습니다. 연결을 확인한 뒤 다시 시도하세요.",
      wgRelayError_delete_prepare_failed: "로컬 삭제를 안전하게 준비하지 못해 아무것도 삭제하지 않았습니다.",
      wgRelayError_delete_failed: "로컬 구성을 완전히 삭제하지 못했습니다. 다시 시도하세요.",
      wgRelayError_connection_failed: "이 PC에서 원격 연결을 설정할 수 없습니다.",
      wgRelayError_sidecar_failed: "내장 WireGuard 터널을 이 플랫폼에서 시작할 수 없습니다.",
      wgRelayError_health_failed: "WireGuard 터널은 시작됐지만 Relay 상태 확인에 실패했습니다.",
      wgRelayError_relay_failed: "Relay 연결을 설정할 수 없습니다.",
      wgRelayError_unknown: "원격 연결에 실패했습니다. 다시 시도하거나 복구 / 재배포를 사용하세요.",
    },
    ja: {
      sidebarWgRelay: "リモート接続",
      wgRelayTitle: "リモート接続",
      wgRelaySubtitle: "自分の WireGuard Relay をワンクリックで展開し、この PC とスマートフォン 1 台を接続します。",
      wgRelaySetupTitle: "リモート接続を展開",
      wgRelaySetupDescription: "次の 4 つの SSH 情報を入力すると、Clawd が Relay を自動でインストール・設定します。",
      wgRelayFieldHost: "パブリック IP またはドメイン",
      wgRelayFieldSshUsername: "SSH ユーザー名",
      wgRelayFieldSshPort: "SSH ポート",
      wgRelayFieldPassword: "SSH パスワード",
      wgRelayFieldWgPort: "WireGuard UDP ポート",
      wgRelayFieldSubnet: "WireGuard サブネット",
      wgRelayFieldRelayPort: "Relay ポート",
      wgRelayPasswordOneTimeHint: "今回の展開にのみ使用します。送信直後に消去され、保存されません。",
      wgRelayRepairPasswordHint: "現在の SSH パスワードを入力してください。以前のパスワードは保持・再利用しません。",
      wgRelayDeploy: "リモート接続を展開",
      wgRelayDeploying: "展開中…",
      wgRelayTryDeployAgain: "展開を再試行",
      wgRelayDeploymentFailedTitle: "展開に失敗しました",
      wgRelayShowDetails: "詳細を表示",
      wgRelayProgressOverall: "全体の進行状況",
      wgRelayProgressLabel: "展開の進行状況",
      wgRelayStep_connect: "VPS に接続",
      wgRelayStep_fingerprint: "SSH フィンガープリントを確認",
      wgRelayStep_upload: "Relay ファイルをアップロード",
      wgRelayStep_dependencies: "システム依存関係をインストール",
      wgRelayStep_wireguard: "WireGuard を設定",
      wgRelayStep_relay: "Relay とファイアウォールを設定",
      wgRelayStep_verify: "サービスを起動・検証",
      wgRelayStep_save: "PC 設定を保存",
      wgRelayStep_pcConnect: "この PC を接続",
      wgRelayStep_qr: "スマートフォン用ペアリング QR コードを生成",
      wgRelayProgress_pending: "待機中",
      wgRelayProgress_current: "進行中",
      wgRelayProgress_completed: "完了",
      wgRelayProgress_failed: "失敗",
      wgRelayStatus_checking: "接続を確認中",
      wgRelayStatus_idle: "未接続",
      wgRelayStatus_starting_tunnel: "トンネルを起動中",
      wgRelayStatus_verifying_relay: "Relay を検証中",
      wgRelayStatus_connecting_relay: "Relay に接続中",
      wgRelayStatus_connected: "接続済み",
      wgRelayStatus_disconnecting: "切断中",
      wgRelayStatus_failed: "接続失敗",
      wgRelayChecking: "確認中…",
      wgRelayConnect: "このコンピューターを接続",
      wgRelayConnecting: "接続中…",
      wgRelayDisconnect: "リモート接続を切断",
      wgRelayDisconnecting: "切断中…",
      wgRelayVpsRow: "VPS Relay",
      wgRelayComputerRow: "このコンピューター",
      wgRelayAndroidRow: "Android",
      wgRelayVpsConfigured: "設定済み",
      wgRelayAndroidChecking: "ペアリング可能か確認中",
      wgRelayAndroidPairingAvailable: "ペアリング可能",
      wgRelayAndroidUnavailable: "修復するまで利用不可",
      wgRelayAdvancedManagement: "詳細管理",
      wgRelayRepairRequiredTitle: "修復が必要です",
      wgRelayShowQr: "ペアリング QR コードを表示",
      wgRelayRotatePhone: "別のスマートフォンをペアリング",
      wgRelayRepair: "修復 / 再展開",
      wgRelayDelete: "設定を削除",
      wgRelayRecoveryRequired: "この接続を使う前に修復または再展開が必要です。",
      wgRelayQrTitle: "スマートフォン用ペアリング QR コード",
      wgRelayQrAlt: "Clawd モバイルアプリをこの Relay とペアリングする QR コード",
      wgRelayQrWarning: "この QR コードには機密性の高いペアリングデータが含まれます。対象のスマートフォンだけに表示し、完了後は閉じてください。",
      wgRelayQrClose: "QR コードを閉じる",
      wgRelayRotateConfirmTitle: "別のスマートフォンをペアリングしますか？",
      wgRelayRotateConfirmDetail: "以前のスマートフォンは直ちに無効になり、接続できなくなります。",
      wgRelayRotateConfirmAction: "以前のスマートフォンを無効化",
      wgRelayDeleteConfirmTitle: "ローカル設定を削除しますか？",
      wgRelayDeleteConfirmDetail: "この PC の設定と秘密データを削除します。VPS 上のサービスは動作を続けます。",
      wgRelayDeleteConfirmAction: "ローカル設定を削除",
      wgRelayRepairTitle: "修復または再展開",
      wgRelayRepairDescription: "詳細設定の既定値を確認し、現在の SSH パスワードを入力して再展開します。",
      wgRelayRepairDeploy: "修復 / 再展開",
      wgRelayCancel: "キャンセル",
      wgRelayError_invalid_profile: "パブリックアドレス、SSH ユーザー名、SSH ポートを確認してください。",
      wgRelayError_password_required: "今回の展開に使う SSH パスワードを入力してください。",
      wgRelayError_runtime_unavailable: "このビルドではリモート接続を利用できません。",
      wgRelayError_deploy_failed: "展開に失敗しました。VPS アドレス、SSH 接続、ファイアウォールを確認して再試行してください。",
      wgRelayError_deploy_aborted: "展開がキャンセルされました。再利用前に修復または再展開してください。",
      wgRelayError_remote_commit_recovery_required: "VPS は変更された可能性がありますが、ローカル保存が完了していません。接続前に修復または再展開してください。",
      wgRelayError_profile_conflict_recovery_required: "展開中に設定が変更されました。確認後、修復または再展開してください。",
      wgRelayError_secure_storage_unavailable: "安全なストレージを利用できないため、Relay の秘密は保存されません。",
      wgRelayError_secret_store_read_failed: "暗号化された Relay データを読み取れません。修復または再展開が必要です。",
      wgRelayError_local_storage_retry_required: "VPS は準備済みですが、ローカル暗号化ストレージの修復が必要です。",
      wgRelayError_public_profile_retry_required: "VPS は準備済みですが、公開プロファイルを保存する必要があります。",
      wgRelayError_connection_retry_required: "展開は完了しましたが、この PC は接続できませんでした。リモート接続を再試行してください。",
      wgRelayError_pairing_qr_retry_required: "展開は完了しましたが、QR コードを生成できませんでした。もう一度表示してください。",
      wgRelayError_invalid_profile_id: "選択した Relay プロファイルは無効です。",
      wgRelayError_profile_not_found: "この PC に Relay プロファイルがありません。",
      wgRelayError_secrets_not_found: "暗号化された Relay の秘密がありません。修復または再展開が必要です。",
      wgRelayError_pairing_qr_failed: "ペアリング QR コードを生成できません。",
      wgRelayError_rotate_failed: "スマートフォンの再ペアリングに失敗しました。以前のペアリングは有効な場合があります。",
      wgRelayError_rotate_aborted: "再ペアリングがキャンセルされました。接続を確認して再試行してください。",
      wgRelayError_delete_prepare_failed: "安全な削除を準備できなかったため、何も削除されていません。",
      wgRelayError_delete_failed: "ローカル設定を完全に削除できませんでした。再試行してください。",
      wgRelayError_connection_failed: "この PC からリモート接続を確立できません。",
      wgRelayError_sidecar_failed: "内蔵 WireGuard トンネルをこのプラットフォームで起動できません。",
      wgRelayError_health_failed: "WireGuard トンネルは起動しましたが、Relay のヘルスチェックに失敗しました。",
      wgRelayError_relay_failed: "Relay 接続を確立できません。",
      wgRelayError_unknown: "リモート接続に失敗しました。再試行するか、修復 / 再展開を使用してください。",
    },
  };
