...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sidebarWgRelay: "WireGuard Relay",
      wgRelayTitle: "WireGuard Relay",
      wgRelaySubtitle: "Enter a VPS IP + password (or SSH key) to auto-deploy a cross-network relay in one click.",
      wgRelayRuntimeUnavailable: "Relay runtime unavailable — profiles can be edited but deploy is disabled.",
      wgRelaySectionProfiles: "Relay Servers",
      wgRelayAddProfile: "+ Add server",
      wgRelayEmpty: "No relay servers yet. Add one to get started.",
      wgRelayEdit: "Edit",
      wgRelayDelete: "Delete",
      wgRelayDeleteConfirm: "Delete relay server \"{label}\"?",
      wgRelayStatus_idle: "Idle",
      wgRelayStatus_connecting: "Connecting…",
      wgRelayStatus_reconnecting: "Reconnecting…",
      wgRelayStatus_deploying: "Deploying…",
      wgRelayStatus_connected: "Connected",
      wgRelayStatus_failed: "Failed",
      wgRelayFieldPassword: "SSH password",
      wgRelayFieldPasswordPlaceholder: "Enter SSH password",
      wgRelayFieldPasswordHint: "Kept in memory only — re-enter after each app launch; never saved to disk.",
      wgRelayDeploy: "Deploy",
      wgRelayDeploying: "Deploying…",
      wgRelayTunnelUp: "Connect tunnel",
      wgRelayTunnelDown: "Disconnect tunnel",
      wgRelayRegenPhone: "Regenerate phone QR",
      wgRelayStep_connect: "Connecting to server",
      wgRelayStep_detect: "Detecting system",
      "wgRelayStep_install-wg": "Installing WireGuard",
      "wgRelayStep_gen-keys": "Generating keys",
      "wgRelayStep_write-conf": "Writing config",
      "wgRelayStep_start-service": "Starting service",
      wgRelayStep_firewall: "Opening firewall",
      wgRelayStep_readback: "Reading back endpoint",
      wgRelayReadbackTitle: "Relay details",
      wgRelayEndpoint: "Endpoint",
      wgRelayServerPubKey: "Server public key",
      wgRelayPcAddress: "PC address",
      wgRelayRelayAddr: "Relay address",
      wgRelayQrTitle: "Phone join QR",
      wgRelayScanToJoin: "Scan with the phone app to join the tunnel.",
      wgRelayPasswordRequired: "Enter the SSH password before deploying.",
      wgRelayDeploySuccess: "Relay deployed successfully.",
      wgRelayDeployFailed: "Relay deploy failed.",
      wgRelayAddTitle: "Add relay server",
      wgRelayEditTitle: "Edit relay server",
      wgRelayFieldLabel: "Name",
      wgRelayFieldHost: "Host (user@ip)",
      wgRelayFieldPort: "SSH port",
      wgRelayFieldAuthMethod: "Auth method",
      wgRelayAuthKey: "SSH key",
      wgRelayAuthPassword: "Password",
      wgRelayFieldIdentityFile: "Identity file",
      wgRelayFieldIdentityFileHint: "Absolute path to the private key file.",
      wgRelayFieldWgPort: "WireGuard port",
      wgRelayFieldWgSubnet: "WireGuard subnet",
      wgRelayFieldWgSubnetHint: "Private /24 subnet, e.g. 10.8.0.0/24.",
      wgRelayCancel: "Cancel",
      wgRelaySave: "Save",
      wgRelayAddSuccess: "Relay server added.",
      wgRelayUpdateSuccess: "Relay server updated.",
    ...
    zh: {
      ...
      sidebarWgRelay: "WireGuard 中继",
      wgRelayTitle: "WireGuard 中继",
      wgRelaySubtitle: "输入 VPS 的 IP + 密码(或 SSH 密钥),一键自动部署跨网络中继。",
      wgRelayRuntimeUnavailable: "中继运行时不可用 —— 可编辑配置,但无法部署。",
      wgRelaySectionProfiles: "中继服务器",
      wgRelayAddProfile: "+ 添加服务器",
      wgRelayEmpty: "还没有中继服务器,添加一个开始使用。",
      wgRelayEdit: "编辑",
      wgRelayDelete: "删除",
      wgRelayDeleteConfirm: "确定删除中继服务器 “{label}” 吗?",
      wgRelayStatus_idle: "空闲",
      wgRelayStatus_connecting: "连接中…",
      wgRelayStatus_reconnecting: "重连中…",
      wgRelayStatus_deploying: "部署中…",
      wgRelayStatus_connected: "已连接",
      wgRelayStatus_failed: "失败",
      wgRelayFieldPassword: "SSH 密码",
      wgRelayFieldPasswordPlaceholder: "输入 SSH 密码",
      wgRelayFieldPasswordHint: "仅保存在内存中 —— 每次启动后需重新输入,绝不写入磁盘。",
      wgRelayDeploy: "一键部署",
      wgRelayDeploying: "部署中…",
      wgRelayTunnelUp: "连接隧道",
      wgRelayTunnelDown: "断开隧道",
      wgRelayRegenPhone: "重新生成手机二维码",
      wgRelayStep_connect: "连接服务器",
      wgRelayStep_detect: "检测系统",
      "wgRelayStep_install-wg": "安装 WireGuard",
      "wgRelayStep_gen-keys": "生成密钥",
      "wgRelayStep_write-conf": "写入配置",
      "wgRelayStep_start-service": "启动服务",
      wgRelayStep_firewall: "开放防火墙",
      wgRelayStep_readback: "读取回连信息",
      wgRelayReadbackTitle: "中继信息",
      wgRelayEndpoint: "端点",
      wgRelayServerPubKey: "服务器公钥",
      wgRelayPcAddress: "电脑地址",
      wgRelayRelayAddr: "中继地址",
      wgRelayQrTitle: "手机加入二维码",
      wgRelayScanToJoin: "用手机 App 扫码即可加入隧道。",
      wgRelayPasswordRequired: "部署前请先输入 SSH 密码。",
      wgRelayDeploySuccess: "中继部署成功。",
      wgRelayDeployFailed: "中继部署失败。",
      wgRelayAddTitle: "添加中继服务器",
      wgRelayEditTitle: "编辑中继服务器",
      wgRelayFieldLabel: "名称",
      wgRelayFieldHost: "主机 (user@ip)",
      wgRelayFieldPort: "SSH 端口",
      wgRelayFieldAuthMethod: "认证方式",
      wgRelayAuthKey: "SSH 密钥",
      wgRelayAuthPassword: "密码",
      wgRelayFieldIdentityFile: "密钥文件",
      wgRelayFieldIdentityFileHint: "私钥文件的绝对路径。",
      wgRelayFieldWgPort: "WireGuard 端口",
      wgRelayFieldWgSubnet: "WireGuard 子网",
      wgRelayFieldWgSubnetHint: "私有 /24 子网,例如 10.8.0.0/24。",
      wgRelayCancel: "取消",
      wgRelaySave: "保存",
      wgRelayAddSuccess: "中继服务器已添加。",
      wgRelayUpdateSuccess: "中继服务器已更新。",
      ...
      doctorAgentSummaryNoneActive: "没有活跃的集成 — 请至少启用一个。",
    ...
    "zh-TW": {
      ...
      sidebarWgRelay: "WireGuard 中繼",
      wgRelayTitle: "WireGuard 中繼",
      wgRelaySubtitle: "輸入 VPS 的 IP + 密碼(或 SSH 金鑰),一鍵自動部署跨網路中繼。",
      wgRelayRuntimeUnavailable: "中繼執行環境不可用 —— 可編輯設定,但無法部署。",
      wgRelaySectionProfiles: "中繼伺服器",
      wgRelayAddProfile: "+ 新增伺服器",
      wgRelayEmpty: "尚無中繼伺服器,新增一個開始使用。",
      wgRelayEdit: "編輯",
      wgRelayDelete: "刪除",
      wgRelayDeleteConfirm: "確定刪除中繼伺服器「{label}」嗎?",
      wgRelayStatus_idle: "閒置",
      wgRelayStatus_connecting: "連線中…",
      wgRelayStatus_reconnecting: "重新連線中…",
      wgRelayStatus_deploying: "部署中…",
      wgRelayStatus_connected: "已連線",
      wgRelayStatus_failed: "失敗",
      wgRelayFieldPassword: "SSH 密碼",
      wgRelayFieldPasswordPlaceholder: "輸入 SSH 密碼",
      wgRelayFieldPasswordHint: "僅保存在記憶體中 —— 每次啟動後需重新輸入,絕不寫入磁碟。",
      wgRelayDeploy: "一鍵部署",
      wgRelayDeploying: "部署中…",
      wgRelayTunnelUp: "連線通道",
      wgRelayTunnelDown: "中斷通道",
      wgRelayRegenPhone: "重新產生手機 QR 碼",
      wgRelayStep_connect: "連線伺服器",
      wgRelayStep_detect: "偵測系統",
      "wgRelayStep_install-wg": "安裝 WireGuard",
      "wgRelayStep_gen-keys": "產生金鑰",
      "wgRelayStep_write-conf": "寫入設定",
      "wgRelayStep_start-service": "啟動服務",
      wgRelayStep_firewall: "開放防火牆",
      wgRelayStep_readback: "讀取回連資訊",
      wgRelayReadbackTitle: "中繼資訊",
      wgRelayEndpoint: "端點",
      wgRelayServerPubKey: "伺服器公鑰",
      wgRelayPcAddress: "電腦位址",
      wgRelayRelayAddr: "中繼位址",
      wgRelayQrTitle: "手機加入 QR 碼",
      wgRelayScanToJoin: "用手機 App 掃碼即可加入通道。",
      wgRelayPasswordRequired: "部署前請先輸入 SSH 密碼。",
      wgRelayDeploySuccess: "中繼部署成功。",
      wgRelayDeployFailed: "中繼部署失敗。",
      wgRelayAddTitle: "新增中繼伺服器",
      wgRelayEditTitle: "編輯中繼伺服器",
      wgRelayFieldLabel: "名稱",
      wgRelayFieldHost: "主機 (user@ip)",
      wgRelayFieldPort: "SSH 連接埠",
      wgRelayFieldAuthMethod: "認證方式",
      wgRelayAuthKey: "SSH 金鑰",
      wgRelayAuthPassword: "密碼",
      wgRelayFieldIdentityFile: "金鑰檔案",
      wgRelayFieldIdentityFileHint: "私鑰檔案的絕對路徑。",
      wgRelayFieldWgPort: "WireGuard 連接埠",
      wgRelayFieldWgSubnet: "WireGuard 子網",
      wgRelayFieldWgSubnetHint: "私有 /24 子網,例如 10.8.0.0/24。",
      wgRelayCancel: "取消",
      wgRelaySave: "儲存",
      wgRelayAddSuccess: "中繼伺服器已新增。",
      wgRelayUpdateSuccess: "中繼伺服器已更新。",
      ...
      doctorAgentSummaryNoneActive: "沒有活躍的整合 — 請至少啟用一個。",
    ...
    ko: {
      ...
      sidebarWgRelay: "WireGuard 릴레이",
      wgRelayTitle: "WireGuard 릴레이",
      wgRelaySubtitle: "VPS IP + 비밀번호(또는 SSH 키)를 입력하면 원클릭으로 네트워크 간 릴레이를 자동 배포합니다.",
      wgRelayRuntimeUnavailable: "릴레이 런타임을 사용할 수 없습니다 — 프로필은 편집 가능하지만 배포는 비활성화됩니다.",
      wgRelaySectionProfiles: "릴레이 서버",
      wgRelayAddProfile: "+ 서버 추가",
      wgRelayEmpty: "릴레이 서버가 아직 없습니다. 하나 추가하여 시작하세요.",
      wgRelayEdit: "편집",
      wgRelayDelete: "삭제",
      wgRelayDeleteConfirm: "릴레이 서버 \"{label}\"을(를) 삭제하시겠습니까?",
      wgRelayStatus_idle: "대기",
      wgRelayStatus_connecting: "연결 중…",
      wgRelayStatus_reconnecting: "재연결 중…",
      wgRelayStatus_deploying: "배포 중…",
      wgRelayStatus_connected: "연결됨",
      wgRelayStatus_failed: "실패",
      wgRelayFieldPassword: "SSH 비밀번호",
      wgRelayFieldPasswordPlaceholder: "SSH 비밀번호 입력",
      wgRelayFieldPasswordHint: "메모리에만 유지됩니다 — 앱 실행 시마다 다시 입력해야 하며 디스크에 저장되지 않습니다.",
      wgRelayDeploy: "배포",
      wgRelayDeploying: "배포 중…",
      wgRelayTunnelUp: "터널 연결",
      wgRelayTunnelDown: "터널 해제",
      wgRelayRegenPhone: "휴대폰 QR 재생성",
      wgRelayStep_connect: "서버 연결",
      wgRelayStep_detect: "시스템 감지",
      "wgRelayStep_install-wg": "WireGuard 설치",
      "wgRelayStep_gen-keys": "키 생성",
      "wgRelayStep_write-conf": "설정 작성",
      "wgRelayStep_start-service": "서비스 시작",
      wgRelayStep_firewall: "방화벽 개방",
      wgRelayStep_readback: "엔드포인트 읽기",
      wgRelayReadbackTitle: "릴레이 정보",
      wgRelayEndpoint: "엔드포인트",
      wgRelayServerPubKey: "서버 공개키",
      wgRelayPcAddress: "PC 주소",
      wgRelayRelayAddr: "릴레이 주소",
      wgRelayQrTitle: "휴대폰 참여 QR",
      wgRelayScanToJoin: "휴대폰 앱으로 스캔하여 터널에 참여하세요.",
      wgRelayPasswordRequired: "배포하기 전에 SSH 비밀번호를 입력하세요.",
      wgRelayDeploySuccess: "릴레이가 성공적으로 배포되었습니다.",
      wgRelayDeployFailed: "릴레이 배포에 실패했습니다.",
      wgRelayAddTitle: "릴레이 서버 추가",
      wgRelayEditTitle: "릴레이 서버 편집",
      wgRelayFieldLabel: "이름",
      wgRelayFieldHost: "호스트 (user@ip)",
      wgRelayFieldPort: "SSH 포트",
      wgRelayFieldAuthMethod: "인증 방식",
      wgRelayAuthKey: "SSH 키",
      wgRelayAuthPassword: "비밀번호",
      wgRelayFieldIdentityFile: "키 파일",
      wgRelayFieldIdentityFileHint: "개인 키 파일의 절대 경로.",
      wgRelayFieldWgPort: "WireGuard 포트",
      wgRelayFieldWgSubnet: "WireGuard 서브넷",
      wgRelayFieldWgSubnetHint: "프라이빗 /24 서브넷, 예: 10.8.0.0/24.",
      wgRelayCancel: "취소",
      wgRelaySave: "저장",
      wgRelayAddSuccess: "릴레이 서버가 추가되었습니다.",
      wgRelayUpdateSuccess: "릴레이 서버가 업데이트되었습니다.",
    ...
    ja: {
      ...
      sidebarWgRelay: "WireGuard リレー",
      wgRelayTitle: "WireGuard リレー",
      wgRelaySubtitle: "VPS の IP + パスワード(または SSH 鍵)を入力すると、ワンクリックでネットワーク間リレーを自動デプロイします。",
      wgRelayRuntimeUnavailable: "リレーランタイムが利用できません — プロファイルは編集できますが、デプロイは無効です。",
      wgRelaySectionProfiles: "リレーサーバー",
      wgRelayAddProfile: "+ サーバーを追加",
      wgRelayEmpty: "リレーサーバーがまだありません。追加して始めましょう。",
      wgRelayEdit: "編集",
      wgRelayDelete: "削除",
      wgRelayDeleteConfirm: "リレーサーバー「{label}」を削除しますか?",
      wgRelayStatus_idle: "待機",
      wgRelayStatus_connecting: "接続中…",
      wgRelayStatus_reconnecting: "再接続中…",
      wgRelayStatus_deploying: "デプロイ中…",
      wgRelayStatus_connected: "接続済み",
      wgRelayStatus_failed: "失敗",
      wgRelayFieldPassword: "SSH パスワード",
      wgRelayFieldPasswordPlaceholder: "SSH パスワードを入力",
      wgRelayFieldPasswordHint: "メモリ内にのみ保持されます — 起動ごとに再入力が必要で、ディスクには保存されません。",
      wgRelayDeploy: "デプロイ",
      wgRelayDeploying: "デプロイ中…",
      wgRelayTunnelUp: "トンネル接続",
      wgRelayTunnelDown: "トンネル切断",
      wgRelayRegenPhone: "スマホ QR を再生成",
      wgRelayStep_connect: "サーバーへ接続",
      wgRelayStep_detect: "システム検出",
      "wgRelayStep_install-wg": "WireGuard をインストール",
      "wgRelayStep_gen-keys": "鍵を生成",
      "wgRelayStep_write-conf": "設定を書き込み",
      "wgRelayStep_start-service": "サービスを起動",
      wgRelayStep_firewall: "ファイアウォールを開放",
      wgRelayStep_readback: "エンドポイントを読み取り",
      wgRelayReadbackTitle: "リレー情報",
      wgRelayEndpoint: "エンドポイント",
      wgRelayServerPubKey: "サーバー公開鍵",
      wgRelayPcAddress: "PC アドレス",
      wgRelayRelayAddr: "リレーアドレス",
      wgRelayQrTitle: "スマホ参加 QR",
      wgRelayScanToJoin: "スマホアプリでスキャンしてトンネルに参加します。",
      wgRelayPasswordRequired: "デプロイ前に SSH パスワードを入力してください。",
      wgRelayDeploySuccess: "リレーのデプロイに成功しました。",
      wgRelayDeployFailed: "リレーのデプロイに失敗しました。",
      wgRelayAddTitle: "リレーサーバーを追加",
      wgRelayEditTitle: "リレーサーバーを編集",
      wgRelayFieldLabel: "名前",
      wgRelayFieldHost: "ホスト (user@ip)",
      wgRelayFieldPort: "SSH ポート",
      wgRelayFieldAuthMethod: "認証方式",
      wgRelayAuthKey: "SSH 鍵",
      wgRelayAuthPassword: "パスワード",
      wgRelayFieldIdentityFile: "鍵ファイル",
      wgRelayFieldIdentityFileHint: "秘密鍵ファイルの絶対パス。",
      wgRelayFieldWgPort: "WireGuard ポート",
      wgRelayFieldWgSubnet: "WireGuard サブネット",
      wgRelayFieldWgSubnetHint: "プライベート /24 サブネット、例: 10.8.0.0/24。",
      wgRelayCancel: "キャンセル",
      wgRelaySave: "保存",
      wgRelayAddSuccess: "リレーサーバーを追加しました。",
      wgRelayUpdateSuccess: "リレーサーバーを更新しました。",
