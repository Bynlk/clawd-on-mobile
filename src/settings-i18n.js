...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      mobileQrSection: "QR Code",
      mobileStatusSection: "Connection Status",
      mobileSettingsSection: "Settings",
      mobileLoading: "Loading...",
      mobileCopyInfo: "Copy Connection Info",
      mobileRefreshToken: "Refresh Token",
      mobileWsStatus: "WebSocket Status",
      mobileConnectedDevices: "Connected Devices",
      mobileEnabled: "Enable Mobile Connection",
      mobileEnabledDesc: "Allow mobile devices to connect via WebSocket",
      mobileMaxClients: "Max Clients",
      mobileMaxClientsDesc: "Maximum number of simultaneous mobile connections",
      mobileRemoteApproval: "Remote Approval",
      mobileRemoteApprovalDesc: "Allow approving permissions from mobile device",
      mobileDisconnect: "Disconnect",
      mobileCopied: "Copied to clipboard",
      mobileTokenRefreshed: "Token refreshed, QR code updated",
    },
    zh: {
      settingsTitle: "设置",
      ...
      mobileTitle: "移动端伴侣",
      mobileQrSection: "二维码",
      mobileStatusSection: "连接状态",
      mobileSettingsSection: "设置",
      mobileLoading: "加载中...",
      mobileCopyInfo: "复制连接信息",
      mobileRefreshToken: "刷新 Token",
      mobileWsStatus: "WebSocket 状态",
      mobileConnectedDevices: "已连接设备",
      mobileEnabled: "启用移动端连接",
      mobileEnabledDesc: "允许移动设备通过 WebSocket 连接",
      mobileMaxClients: "最大连接数",
      mobileMaxClientsDesc: "同时连接的移动设备数量上限",
      mobileRemoteApproval: "远程审批",
      mobileRemoteApprovalDesc: "允许从移动端审批权限请求",
      mobileDisconnect: "断开",
      mobileCopied: "已复制到剪贴板",
      mobileTokenRefreshed: "Token 已刷新，二维码已更新",
    },
    "zh-TW": {
      settingsTitle: "設定",
      ...
      sidebarMobile: "行動端",
      mobileTitle: "行動端伴侶",
      mobileQrSection: "QR 碼",
      mobileStatusSection: "連線狀態",
      mobileSettingsSection: "設定",
      mobileLoading: "載入中…",
      mobileCopyInfo: "複製連線資訊",
      mobileRefreshToken: "重新整理 Token",
      mobileWsStatus: "WebSocket 狀態",
      mobileConnectedDevices: "已連線裝置",
      mobileEnabled: "啟用行動端連線",
      mobileEnabledDesc: "允許行動裝置透過 WebSocket 連線",
      mobileMaxClients: "最大連線數",
      mobileMaxClientsDesc: "同時連線的行動裝置數量上限",
      mobileRemoteApproval: "遠端核准",
      mobileRemoteApprovalDesc: "允許從行動端核准權限請求",
      mobileDisconnect: "中斷連線",
      mobileCopied: "已複製到剪貼簿",
      mobileTokenRefreshed: "Token 已重新整理，QR 碼已更新",
    },
    ko: {
      settingsTitle: "설정",
      ...
      sidebarMobile: "모바일",
      mobileTitle: "모바일 컴패니언",
      mobileQrSection: "QR 코드",
      mobileStatusSection: "연결 상태",
      mobileSettingsSection: "설정",
      mobileLoading: "로딩 중...",
      mobileCopyInfo: "연결 정보 복사",
      mobileRefreshToken: "토큰 새로고침",
      mobileWsStatus: "WebSocket 상태",
      mobileConnectedDevices: "연결된 기기",
      mobileEnabled: "모바일 연결 활성화",
      mobileEnabledDesc: "모바일 기기가 WebSocket으로 연결할 수 있도록 허용",
      mobileMaxClients: "최대 클라이언트 수",
      mobileMaxClientsDesc: "동시 모바일 연결의 최대 수",
      mobileRemoteApproval: "원격 승인",
      mobileRemoteApprovalDesc: "모바일 기기에서 권한 요청을 승인할 수 있도록 허용",
      mobileDisconnect: "연결 해제",
      mobileCopied: "클립보드에 복사됨",
      mobileTokenRefreshed: "토큰이 새로고침되었습니다, QR 코드가 업데이트됨",
    },
    ja: {
      settingsTitle: "設定",
      ...
      sidebarMobile: "モバイル",
      mobileTitle: "モバイルコンパニオン",
      mobileQrSection: "QRコード",
      mobileStatusSection: "接続状態",
      mobileSettingsSection: "設定",
      mobileLoading: "読み込み中...",
      mobileCopyInfo: "接続情報をコピー",
      mobileRefreshToken: "トークンを更新",
      mobileWsStatus: "WebSocket ステータス",
      mobileConnectedDevices: "接続デバイス",
      mobileEnabled: "モバイル接続を有効化",
      mobileEnabledDesc: "モバイルデバイスがWebSocketで接続できるようにする",
      mobileMaxClients: "最大クライアント数",
      mobileMaxClientsDesc: "同時モバイル接続の最大数",
      mobileRemoteApproval: "リモート承認",
      mobileRemoteApprovalDesc: "モバイルデバイスからの権限リクエストの承認を許可",
      mobileDisconnect: "切断",
      mobileCopied: "クリップボードにコピーしました",
      mobileTokenRefreshed: "トークンが更新されました、QRコードが更新済み",
    },
  };
